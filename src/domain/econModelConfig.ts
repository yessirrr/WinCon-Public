...
export const PISTOL_ROUNDS = [1, 12] as const;

/** Post-pistol anti-eco indicator rounds */
export const POST_PISTOL_ROUNDS = [2, 13] as const;
 ...
 * outcome: 'win' | 'loss'
 */
export const ECON_TRANSITIONS: Record<string, Record<'win' | 'loss', string>> = {
 ...
 */
export const ECON_TO_BUY: Record<string, string> = {
  BROKE: 'ECO',
  LOW: 'HALF_BUY',
  OK: 'FULL_BUY',
  RICH: 'FULL_BUY',
